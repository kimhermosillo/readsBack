      ...
      return knex('authors').insert([
        {
          ...
          picURL: 'https://s3-us-west-2.amazonaws.com/assessment-images/galvanize_reads/photos/alex_martelli.jpg',
        },
        {
          id: 2,
          authFirst: 'Anna',
          authLast: 'Ravenscroft',
          ...
          picURL: 'https://s3-us-west-2.amazonaws.com/assessment-images/galvanize_reads/photos/anna_ravenscroft.jpg',
        },
        {
          id: 3,
          authFirst: 'Steve',
          ...
          picURL: 'https://s3-us-west-2.amazonaws.com/assessment-images/galvanize_reads/photos/steve_holden.jpg',
        },
        {
          id: 4,
          authFirst: 'Allen B.',
          ...
          picURL: 'https://s3-us-west-2.amazonaws.com/assessment-images/galvanize_reads/photos/allen_downey.jpg',
        },
        {
          id: 5,
          authFirst: 'Bonnie',
          ...
          picURL: 'https://s3-us-west-2.amazonaws.com/assessment-images/galvanize_reads/photos/bonnie_eisenman.jpg',
        },
        {
          id: 6,
          authFirst: 'Kyle',
          ...
          picURL: 'https://s3-us-west-2.amazonaws.com/assessment-images/galvanize_reads/photos/kyle_simpson.jpg',
        },
      ])
    }).then(() => {
      return knex.raw('ALTER SEQUENCE authors_id_seq RESTART WITH 5;')
    })
}